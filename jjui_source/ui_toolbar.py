...
class ToolBar(ttk.Frame):
    ...
    def new_func_bindings(self,):
        ...
        self.new_ui_entry_search.bind('<KeyPress-Up>',self.new_func_binding_keypress_up)
        self.new_ui_entry_search.bind('<KeyPress-Down>',self.new_func_binding_keypress_down)
        self.new_ui_entry_search.bind('<Double-KeyPress-Escape>',self.new_func_generate_virtual_event_GameListSearchClear)
    ...
    #<<GameListSearchClear>>
    def new_func_generate_virtual_event_GameListSearchClear(self,event=None):
        self.new_var_data_for_search.set("")# 清理
    ...
    def new_func_binding_keypress_up(self,event=None):
        
        string_for_search = self.new_var_data_for_search.get()

        string_for_search = string_for_search.strip()
        
        if not string_for_search: return
        
        self.new_var_data_for_virtual_event_quick_jump = string_for_search
        
        self.event_generate('<<GameList_Quick_Jump_Reverse>>')


    def new_func_binding_keypress_down(self,event=None):
        ...
        self.event_generate('<<GameList_Quick_Jump>>')