...
class Toplevel_Window(tk.Toplevel):
    ...
    def new_func_ui(self,):
        ...
        #r+=1;c=0
        #make_a_radiobutton(r,c,"mame_both" ,_("mame > 0.162,合并"));c+=1
        #
        #r+=1;c=0
    ...
    def new_func_export_xml(self,xml_type="mame0162"):
        ...
        #
        self.new_func_export_xml_mame(file_object,mame_path,command,flag_use_shell)
    ...
    def new_func_export_xml_mame(self,file_object,mame_path,command,flag_use_shell):
